<template>
	<div class="vue-datepicker" @mouseout="endChoice" @mouseover="startMouseOver">
		<label>{{label}}</label>
		<input type="text" readonly="readonly" autocomplete="off" disableautocomplete :name="field" :id="field" :value="value" :placeholder="placeholder" @focus="startChoice" @keypress="startChoice" @blur="endChoice" ref="input">
...
.vue-datepicker {
  ...
  color: #666; }
   ...
   .vue-datepicker{ display:flex; margin-bottom: 12/@fz;
	label{ flex:1; line-height:40/@fz;font-family: "\5FAE\8F6F\96C5\9ED1", Microsoft YaHei;font-size: 12px;}
	input{ flex:3; padding:6/@fz; border:#d8d8d8 1px solid;line-height:40/@fz; height: 40/@fz;font-family: "\5FAE\8F6F\96C5\9ED1", Microsoft YaHei;font-size: 12px;}
	}
...
/*https://github.com/dai-siki/vue-datepicker-simple/blob/master/README.md改编而来*/
</style>
